...
# Parsing + Configuration Script – Mov-00001 - Rev. A

This **Parsing + Configuration** script is designed for the **Mov-00001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Mov-00001 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Mov-00001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
